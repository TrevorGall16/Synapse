...
- **Strict Modularity:** Never write a UI component file longer than 400 lines. If it grows larger, extract sub-components (e.g., `<TimelineTrack />`, `<Playhead />`) into their own files.
